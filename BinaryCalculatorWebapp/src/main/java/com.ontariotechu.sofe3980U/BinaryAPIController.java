...
public class BinaryAPIController {
	...
	@GetMapping("/multiply")
	public String multiplyString(@RequestParam(name="operand1") String operand1,
	...
	@GetMapping("/and")
	public String andString(@RequestParam(name="operand1") String operand1,
							@RequestParam(name="operand2") String operand2) {
		Binary number1 = new Binary(operand1);
		Binary number2 = new Binary(operand2);
	...
	@GetMapping("/or")
	public String orString(@RequestParam(name="operand1") String operand1,
						@RequestParam(name="operand2") String operand2) {
		Binary number1 = new Binary(operand1);
		Binary number2 = new Binary(operand2);
